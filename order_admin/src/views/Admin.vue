...
<v-app>
  <v-navigation-drawer app :clipped="$vuetify.breakpoint.smAndUp" v-model="drawer">
    ...
    <v-app-bar :clipped-left="$vuetify.breakpoint.smAndUp" app color="light-blue darken-4" dark>   
